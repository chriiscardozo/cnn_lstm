...
class BHAA(Layer):
	...
	def call(self, inputs):
		...
		h1 = K.sqrt( (K.square((K.pow(2.0, pot)*self.l*inputs) + 1.0)/K.pow(4.0,pot)) + K.square(self.t1) )
		h2 = K.sqrt( (K.square((K.pow(2.0, pot)*self.l*inputs) - 1.0)/K.pow(4.0,pot)) + K.square(self.t2) )
